...
public class SendMsgUtil {
    ...
    private static final String
            APP_KEY="7b817fbef5d2b29d0d70bbf3ef9a0a4e";
    //网易云信分配的密钥，请替换你在管理后台应用下申请的appSecret
    private static final String APP_SECRET="0e8a07e6b690";
    //随机
    private static final String NONCE= RandomStringUtils.randomAlphanumeric(10);
    //短信模板ID
    private static final String TEMPLATEID="14836333";
    //手机号
    private static final String MOBILE="19937762942";
    //验证码长度，范围4～10，默认为4
